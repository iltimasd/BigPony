...
if (window.requestIdleCallback) {
    requestIdleCallback(function () {
        Fingerprint2.get(function (components) {
          var id = Fingerprint2.x64hash128(components.map(function (pair) { return pair.value }).join(), 31) // an array of components: {key: ..., value: ...}
    ...
    setTimeout(function () {
        Fingerprint2.get(function (components) {
          console.log(components.murmur) // an array of components: {key: ..., value: ...}
        })  
    }, 10)
}
